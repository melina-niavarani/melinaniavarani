<template>
  <div class="min-h-screen">
    <div class="mx-auto min-h-screen max-w-full px-5 py-10 font-sans md:px-10 md:py-16 lg:px-20 lg:py-0 xl:px-24">
      <section class="lg:flex lg:gap-10 lg:justify-between">
        <header class="lg:sticky lg:top-0 lg:max-h-screen lg:w-[48%] lg:flex-col lg:justify-between lg:py-20 xl:py-24">
        ...
        <main id="content" class="pt-14 lg:w-[52%] lg:py-24">
          <about/>
        </main>
      </section>
