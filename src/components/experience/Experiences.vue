      ...
      <div class="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
        <div class="mb-12 text-center">
          ...
          <p class="mt-4 text-lg text-neutral-300 max-w-2xl mx-auto">
            My professional journey in frontend development and digital marketing
          </p>
        </div>
            ...
            <div class="grid gap-6 lg:grid-cols-3 lg:gap-8">
              ...
              <div class="lg:col-span-2">
                <h3 class="text-2xl font-bold mb-4">
                  ...
                  >
                    Full-stack Developer · <span class="gradient-text">Rahrosell (Online Bookstore)</span>
              ...
              <div class="lg:col-span-2">
                <h3 class="text-2xl font-bold mb-4">
                  <a
                    ...
                    class="group/link inline-flex items-baseline font-bold leading-tight text-neutral-100 hover:text-primary-300 focus-visible:text-primary-300 transition-colors duration-200"
                  >
                    Frontend Developer · <span class="gradient-text">RevivoEarth</span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="inline-block h-5 w-5 shrink-0 transition-transform group-hover/link:-translate-y-1 group-hover/link:translate-x-1 group-focus-visible/link:-translate-y-1 group-focus-visible/link:translate-x-1 motion-reduce:transition-none ml-2 translate-y-px" aria-hidden="true">
                      <path fill-rule="evenodd" d="M5.22 14.78a.75.75 0 001.06 0l7.22-7.22v5.69a.75.75 0 001.5 0v-7.5a.75.75 0 00-.75-.75h-7.5a.75.75 0 000 1.5h5.69l-7.22 7.22a.75.75 0 000 1.06z" clip-rule="evenodd"></path>
                    </svg>
                  </a>
                ...
                <p class="text-neutral-300 leading-relaxed mb-6">
                  Developed the frontend of RevivoEarth, a platform focused on environmental awareness. Built with <span class="font-semibold text-primary-300">Next.js, TypeScript, and Tailwind</span>, optimized for accessibility and scalability.
                </p>
                <div class="flex flex-wrap gap-2">
                  <span class="glass-card px-3 py-1 text-xs font-medium text-primary-300">Next.js</span>
                  <span class="glass-card px-3 py-1 text-xs font-medium text-accent-300">TypeScript</span>
                  <span class="glass-card px-3 py-1 text-xs font-medium text-primary-300">Tailwind CSS</span>
                  <span class="glass-card px-3 py-1 text-xs font-medium text-accent-300">Accessibility</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="grid gap-6 lg:grid-cols-3 lg:gap-8">
              ...
              <div class="lg:col-span-2">
                ...
                <div class="flex flex-wrap gap-2">
                  ...
                  <span class="glass-card px-3 py-1 text-xs font-medium text-primary-300">Multilingual</span>
                  <span class="glass-card px-3 py-1 text-xs font-medium text-accent-300">Corporate Website</span>
                  <span class="glass-card px-3 py-1 text-xs font-medium text-primary-300">B2B Platform</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="lg:col-span-2">
                <h3 class="text-2xl font-bold mb-4">
                  <a
                    ...
                    class="group/link inline-flex items-baseline font-bold leading-tight text-neutral-100 hover:text-primary-300 focus-visible:text-primary-300 transition-colors duration-200"
                  >
                    SEO & Digital Marketing Specialist · <span class="gradient-text">Dejpa Holding</span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="inline-block h-5 w-5 shrink-0 transition-transform group-hover/link:-translate-y-1 group-hover/link:translate-x-1 group-focus-visible/link:-translate-y-1 group-focus-visible/link:translate-x-1 motion-reduce:transition-none ml-2 translate-y-px" aria-hidden="true">
                      <path fill-rule="evenodd" d="M5.22 14.78a.75.75 0 001.06 0l7.22-7.22v5.69a.75.75 0 001.5 0v-7.5a.75.75 0 00-.75-.75h-7.5a.75.75 0 000 1.5h5.69l-7.22 7.22a.75.75 0 000 1.06z" clip-rule="evenodd"></path>
                    </svg>
                  </a>
                ...
                <p class="text-neutral-300 leading-relaxed mb-6">
                  Led SEO strategy and digital marketing for Dejpa's main website in the oil and bitumen industry. Implemented keyword strategy, content optimization, and technical SEO to improve visibility in both local and international markets.
                </p>
                <div class="flex flex-wrap gap-2">
                  <span class="glass-card px-3 py-1 text-xs font-medium text-primary-300">SEO</span>
                  <span class="glass-card px-3 py-1 text-xs font-medium text-accent-300">Digital Marketing</span>
        ...
        <div class="mt-12 text-center">
          <a
            ...
            target="_blank"
          >
            <span class="gradient-text font-semibold">View Full Résumé</span>
